...
- [ ] Explain what a token is used for.
  ...
  Answer: A token is usually taken from the server and stored in your local host so you have access to login (authentication)
  data while you are on the website.  With that token, you can do whatever the server will allow you to do like edit and
  delete files.

- [ ] What steps can you take in your web apps to keep your data secure?

  Answer: Encription would be the biggest thing, using third party libraries.  You also wouldn't want to send the actual token back and forth with your api calls, you would only want to send encrypted data.

- [ ] Describe how web servers work.

  Answer: A web server is connected to the internet.  Once connected, it can communicate with other databases and servers to send information to whomever requests some data.  It can also send data to a database to be stored.

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

  Answer: Create can be tied to axios.post, read can be tied to axios.get(), update can be tied to axios.put() and delete can be tied to axios.delete.
